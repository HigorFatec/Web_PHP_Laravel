...
<div class="row">
    ...
    <span class="card-title center">Reprovar fornecedor</span>

    <p><strong>Fornecedor:</strong> {{ $fornecedor->razao_social }}</p>

    <form method="POST" action="{{ route('empresa.reprovar', $fornecedor->approval_token) }}">
        @csrf
