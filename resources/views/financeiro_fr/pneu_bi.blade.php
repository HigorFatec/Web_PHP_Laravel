                        ...
                        <div class="card-content" style="padding: 15px;">
                            ...
                            <div class="center-align">
                                <div class="nav-segment-container">
                                    <a href="{{ route('reserva.reservas') }}" class="nav-segment-btn {{ Request::routeIs('reserva.reservas') ? 'active' : '' }}">
                                        <i class="fa-solid fa-clock-check"></i> <span>Solicitações Aprovadas</span>
                                    </a>

                                    <a href="{{ route('reserva.bi') }}" class="nav-segment-btn {{ Request::routeIs('reserva.bi') ? 'active' : '' }}">
