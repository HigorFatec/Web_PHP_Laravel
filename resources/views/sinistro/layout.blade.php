...
<body>
  ...
  <nav class="red">
    <div class="nav-wrapper container">
      <a href="#" class="brand-logo center">Sinistro - Solicitações</a>
    ...
    @else
      <ul id="nav-mobile" class="right">
        <li><a href="{{route('sinistro.index')}}">Login <i class="material-icons right">lock</i></a></li>
      </ul>
    @endauth
...
<script>
    function selecionarTipo(valor) {
        document.getElementById('tipo_sinistro').value = valor;

        // Opcional: destaca botão
