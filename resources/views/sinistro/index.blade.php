...
<form action="{{route('sinistro.store')}}"method="POST" enctype="multipart/form-data">
    ...
    <select name="filial_origem" id="filial_origem" required>
        ...
        <span class="card-title center"><b>Dados do Terceiro</b></span>

    E-mail (Terceiro): <br> 
    <input type="email" name="email_terceiro" id="email_terceiro" required> <br>

    Telefone de Contato (Terceiro): <br>
    <input type="text" name="telefone_terceiro" id="telefone_terceiro" required> <br>

    Nome (Terceiro):
    <input type="text" name="nome_terceiro" id="nome_terceiro" required> <br>

    Placa (Terceiro):
    <input type="text" name="placa_terceiro" id="placa_terceiro" required> <br>

    Endereço do Terceiro:
    <input type="text" name="endereco_terceiro" id="endereco_terceiro" required> <br>
    ...
    Documento do veiculo do Terceiro:<br>
    <input type="file" name="foto_2_terceiro" id="foto_2_terceiro" accept="image/*" required><br><br>

    CNH:<br>
    <input type="file" name="foto_3" id="foto_3" accept="image/*" ><br><br>

    CNH do Terceiro:<br>
    <input type="file" name="cnh_terceiro" id="cnh_terceiro" accept="image/*" required><br><br>

    COMPROVANTE DE ENDEREÇO:<br>
    <input type="file" name="foto_4" id="foto_4" accept="image/*" ><br><br>

    Orçamento:<br>
    <input type="file" name="foto_5" id="foto_5" accept="image/*" ><br><br>

    Foto do Ocorrido:<br>
    <input type="file" name="foto_ocorrido" id="foto_ocorrido" accept="image/*" multiple><br><br><br>
