...
<body>
  ...
  <nav class="red">
    <div class="nav-wrapper container">
      <a href="#" class="brand-logo center">Saldo de Combustivel - Rede Frotas</a>
      ...
      <ul id="nav-mobile" class="brand-logo right">
        <li class="hide-on-med-and-down">
          <i class="material-icons left" style="margin-left:550px">visibility</i>{{ \Illuminate\Support\Facades\DB::table('sessions')->where('user_id','!=',null)->count() }}
        </li>
      </ul>
